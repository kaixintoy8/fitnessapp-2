                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          color: selectedTab == 0 ? Color(0xFF62D794) : Colors.transparent,
                          ),
                        )
                      ],
                    )),
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(20),
                          color: selectedTab == 1 ? Color(0xFF62D794) : Colors.transparent,),
                        )
                      ],
                    )),
                  GestureDetector(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(20),
                          color: selectedTab == 2 ? Color(0xFF62D794) : Colors.transparent,
                          ),
                        )
                      ],
                    )),
