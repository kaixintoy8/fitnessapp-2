import 'package:fitnessapp/sign_in/email/continue_email.dart';
import 'package:flutter/material.dart';

class AccepSecondPage extends StatefulWidget {
  const AccepSecondPage({super.key});

  @override
  State<AccepSecondPage> createState() => _AcceptPageState();
}

class _AcceptPageState extends State<AccepSecondPage> {
  @override
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ContinueEmail()));
                                }, 
