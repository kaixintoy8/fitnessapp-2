          ...
          children: [
                ...
                Stack(
                  children: [
                    Container(
                      height: 800,
                      width: 400,
                      child: Image.asset("images/starting_first.png",fit: BoxFit.fill,)),
                      Positioned(
                        left: 0,
                        right: 0,
                        bottom: 140,
                        child: Container(
                          height: 120,
                          width: 350,
                          child: Text("Track your progress and workout history in one convenient app.",style: TextStyle(color: Colors.white,fontSize: 30),textAlign: TextAlign.center,))
                      )
                  ],
                ),
              ],
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>StartingThird()));
                }, 
