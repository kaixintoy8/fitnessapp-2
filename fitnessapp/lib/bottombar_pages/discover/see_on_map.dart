        ...
        children: [
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          border: Border(
                            right: BorderSide(color: const Color.fromARGB(134, 101, 99, 99)),
                          ),
                          color: Colors.black
                        ),
                          child: Row(
                            ...
                            children: [
                              Container(
                                height: 25,
                                width: 25,
                                child: Image.asset("images/popular.png",fit: BoxFit.cover,)
                              ),
                              SizedBox(width: 10,),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              height: 25,
                              width: 25,
                              child: Image.asset("images/filters.png",fit: BoxFit.cover,),
                            ),
                            SizedBox(width: 10,),
                  ...
                  Stack(
                    children: [
                      ...
                      height:1200,
                      width: 470,
                      child: Image.asset("images/fullmap.png",fit: BoxFit.cover,)),
                      
                      Positioned(
                        left: 110,
                        top: 210,
                        child: Icon(Icons.radio_button_checked_outlined,color: Color(0xFF62D794),size: 30,)
                      ),
                      Positioned(
                        left: 40,
                        top: 330,
                      ...
                      Positioned(
                        left: 125,
                        top: 500,
                        child: Icon(Icons.radio_button_checked_outlined,color: Colors.orange,size: 30,)
                      ),
                      Positioned(
                        left: 250,
                        top: 670,
          ...
          child: SizedBox(
            ...
            label: GestureDetector(
              ...
              child: Text("Back to list",style: TextStyle(color: Colors.white,fontSize: 18),))
            ),
          ),
          ),
        ],
